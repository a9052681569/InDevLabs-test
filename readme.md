# InDevLabs-test
## [(нажми и увидишь)](https://a9052681569.github.io/InDevLabs-test/)
### версия 1.0.0
##### Тестовое задание для работодателя, показывает значения нескольких котировок с крипто биржи kraken.
